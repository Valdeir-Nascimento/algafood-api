...
public interface GrupoControllerSwagger {
    ...
    GrupoDTO adicionar(@ApiParam(name = "corpo", value = "Representação de um novo grupo") GrupoInput grupoInput);
    ...
    GrupoDTO atualizar( @ApiParam(value = "ID de um grupo", example = "1") Long grupoId, GrupoInput grupoInput);
